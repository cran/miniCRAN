...
The value that is returned via `addPackage` is the number of packages written to the index file, *i.e.*, the total number of packages in the repo of that type.
